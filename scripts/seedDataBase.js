...
// // Create sample trainers with years of experience, age group, and gender distributed based on filters
...
//             { min: 0, max: 2 },  // 0-2 years of experience
//             { min: 3, max: 5 },  // 3-5 years of experience
//             { min: 6, max: 10 }, // 6-10 years of experience
//             { min: 11, max: 15 },// 11-15 years of experience
//             { min: 16, max: 25 } // 16+ years of experience
//         ];

//         const genders = ['Male', 'Female'];

//         // Loop through each subcategory and create trainers for each combination of filters
//         for (const subCategory of subCategories) {
//             for (const ageGroup of ageGroups) {
//                 for (const experienceRange of experienceRanges) {
...
//                         // Create a trainer for each combination of filters
//                         await Trainer.create({
//                             name: faker.person.firstName(),
//                             surname: faker.person.lastName(),
//                             gender, // Use the current gender from the loop
//                             ageGroup, // Use the current age group from the loop
//                             description: faker.lorem.paragraph(),
//                             avatar: faker.image.avatar(),
...
//         console.log('Trainers created successfully with various combinations of filters!');
//     } catch (error) {
...
//                     image: faker.image.url(640, 480, 'service', true, true), // Generate service image
...
//                     whatsIncluded: faker.lorem.sentence(),
//                     whatsNotIncluded: faker.lorem.sentence(),
//                     recommendations: faker.lorem.sentence(),
//                     picture: faker.image.url(640, 480, 'service-details', true, true), // Add random service details image
//                     fullDescription: faker.lorem.paragraph() // Provide a value for fullDescription
//                 });

//                 // Assign trainers to each service based on matching filters
//                 let matchingTrainers = trainers.filter(trainer =>
//                     trainer.subcategoryId === subCategory.id &&
//                     trainer.level === service.level &&
//                     trainer.yearsOfExperience >= 3 // Filter based on years of experience
//                 );
...
//                 // Assign the first 10 matching trainers to the service
...
//         console.log('Sample services, service details, and trainers assigned successfully!');
//     } catch (error) {
